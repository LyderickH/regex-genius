...
- [x] Regex combinée : une seule expression qui extrait toutes les colonnes d'un coup
- [x] Moteur — 4 principes : pénaliser les motifs littéraux, qualifier les délimiteurs (pas de mots de liaison), pivots avant/après, ordre strict des règles multiples
